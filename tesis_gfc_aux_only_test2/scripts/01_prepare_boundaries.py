...
def _write_empty_municipios() -> None:
	"""Write an empty municipalities layer with the expected schema."""
	...
	empty.to_file(OUTPUT_FILE, layer=OUTPUT_LAYER, driver="GPKG")
	print(f"Warning: boundaries not available. Wrote empty municipalities layer to: {OUTPUT_FILE}")
